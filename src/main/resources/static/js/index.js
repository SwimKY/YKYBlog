    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2020年8月10日0点';

    //网站开始时间
    var siteBeginRunningTime = '2020-08-10 00:00:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://ykyblog.oss-cn-shenzhen.aliyuncs.com/blog_front/qq.png");
        $('.weixin_code').attr("src","https://ykyblog.oss-cn-shenzhen.aliyuncs.com/blog_front/weixin.jpg");
    });
